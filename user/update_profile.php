...
$query="update user set name='$n',mobile='$mob',gender='$gen',hobbies='$hob',usn='$usn' where email='".$_SESSION['user']."'";

//$query="insert into user values('','$n','$e','$pass','$mob','$gen','$hob','$imageName','$usn',now())";
