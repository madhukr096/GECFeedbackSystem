...
<form method="post">
	...
	<caption><h2 style="margin-top: 10px" align="center">Faculty Login Form</h2></caption><br>
	
	
	<div class="row" style="margin-top:10px">
		<div class="col-sm-4">Enter Your Email</div>
		<div class="col-sm-5">
		<input type="email" name="e" class="form-control" placeholder="vetri@gmail.com" /></div>
	</div>
	
	<div class="row" style="margin-top:10px">
		<div class="col-sm-4">Enter Your Password</div>
		<div class="col-sm-5">
		<input type="password" name="p" class="form-control" placeholder="vetri" /></div>
	</div>
