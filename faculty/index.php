    ...
    <div class="container-fluid">
      <div class="row">
		...
		<!-- check users profile image -->
			...
			{
			?>
            <li><a href="#"><img style="border-radius:50px" src="faculty.png" width="100" height="100" /></a></li>
			<?php 
			}
			else
			{
            ...
            <li><a href="index.php?page=question"><span class="glyphicon glyphicon-thumbs-up"></span> Questions</a></li>
          </ul>
